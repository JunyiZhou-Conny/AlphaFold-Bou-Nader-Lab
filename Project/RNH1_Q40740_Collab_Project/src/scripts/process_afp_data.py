...
afp_data = pd.read_csv('/Users/conny/Desktop/AlphaFold/Project/RNH1_Q40740_Collab_Project/results/afp_predictions_with_good_interpae_cutoff_100.csv')
...
pdb_dir = '/Users/conny/Desktop/AlphaFold/Project/RNH1_Q40740_Collab_Project/results/Best_Proteins_MMseqs2'
...
with open('copy_pdb_files.sh', 'w') as f:
    ...
    f.write('dest_dir="/Users/conny/Desktop/AlphaFold/Project/RNH1_Q40740_Collab_Project/results/Best_Proteins_MMseqs2"\n\n')
